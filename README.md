...
## Interview Explanation (How to explain in 30–60 seconds)
“This project simulates a real mobile notification system that adapts delivery decisions using both network conditions and user context. For obvious safety/urgency cases, I use rule-based overrides. For everything else, I trained a machine learning classifier that predicts whether to send immediately, delay, or suppress. The networking angle is that weak connectivity should change delivery strategy—like delaying non-urgent messages to avoid waste and retries—while urgent alerts should still go through.”

---

## Resume Bullet Points
- Built a context-aware notification decision system using Python, Streamlit, and machine learning to classify notifications as send, delay, or suppress.
- Combined rule-based automation with AI-driven prediction to improve notification timing based on user activity and network conditions.
- Developed a networking-focused demo project showing how connectivity awareness can enhance application-level user experience.